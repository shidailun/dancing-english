...
Three engines, because the first question about narration is who pays:
    ...
    python scripts/narrate.py pas01                      # edge, free
    python scripts/narrate.py --engine sapi pas01        # offline, free
    python scripts/narrate.py --engine elevenlabs pas01  # paid, best
