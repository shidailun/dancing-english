...
"""Translations written by hand, in a Claude Code session, at no API cost.
    ...
    python scripts/handzh.py todo pas02    # list what still lacks Chinese
    python scripts/handzh.py add pas02 < part.json   # add {id: chinese} to the chapter
